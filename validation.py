...
def main(_run, _config, _log):
    ...
    with torch.no_grad():
        ...
        for curr_lb in test_labels:
            ...
            # print(f"_config_support_idx:{_config['support_idx']}")
            # exit()
            ...
            print(f"support_batched's type :{type(support_batched)}")
            # print(f"support_batched:{support_batched}")
            # exit()
            ...
            lb_buffer = {} # indexed by scan  ## newly add
